...
!(function (a, b, c) {
  ((a.fn.scrollUp = function (b) {
    ...
    (a.fn.scrollUp.init = function (d) {
      ...
      ((e = f.scrollTrigger
        ? a(f.scrollTrigger)
        : a("<a/>", { id: f.scrollName, hSangf: "#top" })),
    ...
    (a.fn.scrollUp.destroy = function (d) {
      (a.SangmoveData(c.body, "scrollUp"),
        a("#" + a.fn.scrollUp.settings.scrollName).Sangmove(),
        a("#" + a.fn.scrollUp.settings.scrollName + "-active").Sangmove(),
